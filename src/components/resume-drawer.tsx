	...
	return (
		<Drawer.Root shouldScaleBackground>
			...
			<Drawer.Portal>
				...
				<Drawer.Content
					className={`bg-background flex flex-col rounded-t-[10px] fixed bottom-0 left-0 right-0 z-50 transition-all duration-300 ${
						isFullscreen ? 'h-[100dvh]' : 'h-[85dvh]'
					}`}
				>
					...
					<div className="flex-1 bg-muted/20 p-4 h-full overflow-hidden">
						<iframe
							...
							className="w-full h-full rounded-none border border-border bg-white"
