...
export const WORK_EXPERIENCE: ExperienceItemType[] = [
	{
		...
		storeLinks: {
			apple:
				'https://apps.apple.com/in/app/first-demat-stock-trading-app/id6772088334',
			android:
				'https://play.google.com/store/apps/details?id=com.firstdemat.trade'
		},
		positions: [
			{
...
- Built a **configurable WebSocket client** for *direct binary feed consumption*
...
- Created a *compile-time safe* architecture through generated contracts`,
	...
	},
	{
		...
		storeLinks: {
			apple:
				'https://apps.apple.com/in/app/5paisa-share-market-mf-ipo/id1156366609',
			android:
...
- Brought average screen load from **1.7s** to **0.95s** with caching, pagination, and tighter request handling; cut session drops by **90%**; kept **85%+** coverage on critical modules with unit, widget, and golden tests.`,
	...
	},
	{
		...
		storeLinks: {
			apple:
				'https://apps.apple.com/us/app/flash-co-ai-powered-shopping/id6444209029',
			android:
				'https://play.google.com/store/apps/details?id=com.flashmonk.flash'
		},
		positions: [
			{
